...
// Demo route
$route[$config['base'] . 'hello/(.*)'] = 'pages/hello.php';

$route[$config['base'] . 'portfolio'] = 'pages/portfolio.php';
$route[$config['base'] . 'portfolio/newPortfolio'] = 'pages/newPortfolio.php';

$route[$config['base'] . 'portfolio/([0-9]*)'] = 'pages/project.php';
$route[$config['base'] . 'portfolio/([0-9]*)/newProject'] = 'pages/newProject.php';
$route[$config['base'] . 'portfolio/([0-9]*)/editPortfolio'] = 'pages/editPortfolio.php';

$route[$config['base'] . 'portfolio/([0-9]*)/project/([0-9]*)'] = 'pages/milestones.php';
$route[$config['base'] . 'portfolio/([0-9]*)/project/([0-9]*)/newMilestone'] = 'pages/newMilestone.php';
$route[$config['base'] . 'portfolio/([0-9]*)/project/([0-9]*)/editProject'] = 'pages/editProject.php';

$route[$config['base'] . 'analytics/piechart'] = 'pages/piechart.php';
